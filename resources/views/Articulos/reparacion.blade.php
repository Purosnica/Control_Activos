                          ...
                          <div class="modal-dialog cascading-modal" role="document">
                              ...
                              <div class="modal-content">
                                  ...
                                  <div class="modal-header light-blue darken-3 white-text">
                                      <h4 class="title"><i class="fa fa-pencil"></i>Agregar Reparacion  </h4>
                                  ...
                                  <div class="modal-body mb-0">
                                      <div class="md-form form-sm">
                                          ...
                                          {!!Form::label('Codigo','Código de Reparación')!!}
                                          {!!Form::text('Codigo','',['class'=>'form-control','rows'=>'5'])!!}
                                                        ...
                                                        <div class="md-form form-sm">
                                                          ...
                                                          {!!Form::label('Informe','Informe Técnico')!!}
        ...
        <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Agregar Reparacion</div></a>
    ...
    <tbody>
      ...
      @foreach ($tabla as $info)
        <tr>
          ...
          <td>{{$info->Modelo}}</td>
          <td>{{$info->Serie}}</td>
          <td>{{$info->Fecha_inactivo}}</td>
          <td>{{$info->Observacion}}</td>
          <td>{{$info->Informe_tecnico}}</td>
          <td>{{$info->Fecha}}</td>
        </tr>
      @endforeach
    </tbody>
